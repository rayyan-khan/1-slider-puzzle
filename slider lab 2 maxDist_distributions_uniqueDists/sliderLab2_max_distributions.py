...
print("Time to solve 100: ", time.clock()-start)
print("Average solution length: ", stepCt/100)

maxList = maxDist('12345678_')
print("Furthest puzzle: ", maxList[-1], " Max Length: ", len(maxList)-1)'''

dictLev = puzzlesPerDist("1234_5678")
for k in dictLev:
