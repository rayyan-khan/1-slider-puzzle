...
# changes from 10/21:
# goal lookup table {letter: index}
...
def mnhtPuzzle(puzzle, goal = '_abcdefghijklmno'):
    return sum([mnhtDict[k[0], goalDict[k[1]]] for k in enumerate(puzzle) if k[1] != '_'])
    ...
    while True:
        ...
        for nbr in neighbors(pzStr, space):
            ...
            if nbrPzl == goal:
                ...
                newMnht = mnhtPuzzle(nbrPzl, goal)
                print(nbrPzl, newMnht)
