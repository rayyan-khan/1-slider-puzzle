...
# final version of improvements to finding manhattan distances (as of now)
# future possible improvements:
# mnhtPuzzle only of necessary indices? and cut down on find(k) -- tried but got errors
